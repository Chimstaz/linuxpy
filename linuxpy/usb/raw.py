...
# Date: 2024-02-22 14:09:31.220504
# System: Linux
...
class usb_ssp_cap_descriptor(Struct):
    ...
    class M1(Union):
        ...
        M1._fields_ = [
            ("__empty_bmSublinkSpeedAttr", M1.M1),
            ("bmSublinkSpeedAttr", POINTER(cuint)),
        ]
...
uvc_descriptor_header._fields_ = [
    ("bLength", u8),
    ("bDescriptorType", u8),
